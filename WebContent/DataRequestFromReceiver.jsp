		...
		<div class="row">
			<div class="col-md-12">
				<div class="navbar-header animated fadeInUp">
					<a class="btn btn-primary mt-2" href="DataReceiverHome.jsp">BACK</a>
				</div>
					...
					<table id="myTable" class="table table-bordred table-striped">
						...
						<%
							...
							try {
								...
								PreparedStatement ps1 = con1.prepareStatement("SELECT * FROM `senddata`");
						...
						<tbody>
							...
							<tr>
								...
								<td><a class="btn btn-primary btn-sm"
									href="ReceiverRequestDataServlet?ffilename=<%=rs.getString("fileName")%> &master=<%=rs.getString("masterKey") %> &keyword=<%=rs.getString("keywords")%> &original=<%=rs.getString("orginalContent")%>">Send
										Request</a></td>
