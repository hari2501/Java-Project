...
<body>
					...
					<table id="myTable" class="table table-bordred table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="DownloadServlet?ffilename=<%=rs.getString("filename")%> &originalContent=<%=rs.getString("originalContent")%>">Download</a></td>
	...
	<script>
		...
		if(test=${param.success==0}){
			console.log("success");
			swal("oops!", "Request is Not Accepted", "error");
