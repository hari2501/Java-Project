...
body {
	background: linear-gradient(to right, #008FCA, #11AEEF);
}
</style>
...
<body>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="navbar-header animated fadeInUp">
					<a class="btn btn-primary mt-2" href="IAMHome.jsp">BACK</a>
				</div>
					...
					<table id="myTable" class="table table-bordred table-striped">
						...
						<%
							...
							try {
								...
								PreparedStatement ps1 = con1.prepareStatement("SELECT * FROM `receiverrequest`");
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="AuthenticationRequestToReceiverServlet?ffilename=<%=rs.getString("fileName") %> &secret=<%=rs.getString("secretkey")%> &keyword=<%=rs.getString("keywords") %>" class="btn btn-success btn-sm">Accept</a></td>
	...
	<script>
		...
		if(test=${param.Error==1}){
			console.log("Error");
			swal("Oops!", "Get The Permission by DataSharer!", "error");
